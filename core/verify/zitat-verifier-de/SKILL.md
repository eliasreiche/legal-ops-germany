...
> Prüfung durch den Maintainer gesetzt (siehe [CONVENTIONS.md](../../../CONVENTIONS.md),
> Reifegrad-Leiter).
...
[CONVENTIONS.md](../../../CONVENTIONS.md#zitierdisziplin-3-zustands-marker):
...
```bash
python3 core/verify/zitat-verifier-de/executor.py --input entwurf.md
```
