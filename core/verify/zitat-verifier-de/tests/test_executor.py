"""Tests für core/verify/zitat-verifier-de/executor.py.
...
def test_beispiel_report_ist_golden_file_gegen_frischen_executor_lauf():
    ...
    frisch = executor.baue_report(
        ...
        quelle_datei="core/verify/zitat-verifier-de/schema/beispiel-eingabe.md",
        registry_datei="core/verify/zitat-verifier-de/schema/beispiel-registry.json")
