...
SKILL_DIR = REPO / "plugins" / "legal-ops" / "skills" / "konflikt-check-offline"
...
# plugins/legal-ops/skills/zitat-verifier-de/tests/test_executor.py) fälschlich
# wiederverwenden.
_SPEC = importlib.util.spec_from_file_location(
    "konflikt_check_offline_executor", SKILL_DIR / "executor.py")
