"""Tests für plugins/legal-ops/skills/zitat-pruefer/executor.py.
...
def test_beispiel_report_ist_golden_file_gegen_frischen_executor_lauf():
    ...
    frisch = executor.baue_report(
        ...
        quelle_datei="plugins/legal-ops/skills/zitat-pruefer/schema/beispiel-eingabe.md",
        registry_datei="plugins/legal-ops/skills/zitat-pruefer/schema/beispiel-registry.json")
