#!/usr/bin/env python3
"""akten-intake-strukturierer — deterministischer Provenienz- und Schema-Validator (P2/P3).
...
Datumsnennungen sind KEINE Fristberechnung — dafür ist der Skill `fristenrechner-de`
    ...
    return {
        "meta": {
            ...
            "hinweis": ("Erkannte Datumsnennungen sind KEINE Fristberechnung — "
                        "Fristen nur über den Skill fristenrechner-de (Zweitkontrolle)."),
        },
